...
<div class="box">
	...
	<p>오늘도 좋은 하루 되세요~!!</p>
	<button onclick="location.href='views/member/myInfo.jsp'">회원정보보기
	</button>
...
success : function(data) {
	if(data.result == "ok"){
		...
		+"<p>오늘도 좋은 하루 되세요~!!</p>\
		<button onclick='location.href=\"views/member/myInfo.jsp\"'>
		회원정보보기</button>\
		<button onclick=\"location.href='logout.lo'\">로그아웃
		</button>";
		$(".box").html(text);
		} else {
		alert("로그인 실패!\nID와 비밀번호를 다시 확인하세요.");
